resource "aws_security_group" "allow_quic" {
  name        = "allow_quic"
  description = "Security group allowing all traffic via QUIC"
...
resource "aws_security_group" "allow_https" {
  name        = "allow_https"
  description = "Security group allowing all traffic via HTTPS"
...
resource "aws_security_group" "allow_ssh" {
  name        = "allow_ssh"
  description = "Security group allowing inbound traffic on SSH port"
